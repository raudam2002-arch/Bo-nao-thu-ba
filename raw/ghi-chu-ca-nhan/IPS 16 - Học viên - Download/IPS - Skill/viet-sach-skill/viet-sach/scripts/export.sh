#!/usr/bin/env bash
# Đóng gói skill viet-sach để CHIA SẺ cho người khác.
# Tự động LOẠI BỎ references/_private/ (Voice Pack riêng của Phạm Thành Long).
#
# Dùng:
#   bash scripts/export.sh <thư-mục-đích>
#   bash scripts/export.sh ~/Desktop/viet-sach-share
#
...
echo "   - Đã loại bỏ references/_private/ (Voice Pack riêng)."
echo "   - Người dùng mới sẽ được skill hỏi Voice Pack (intake) khi chạy."
echo ""
